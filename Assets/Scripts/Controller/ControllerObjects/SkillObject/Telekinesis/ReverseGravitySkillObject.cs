...
public class ReverseGravitySkillObject : SkillObject
{
    ...
    {
        ParticleManager.Instance.PullParticleAttachedSync("ShockWaveHand", 0);
        ...
        ParticleManager.Instance.PullParticleSync("ReverseGravityFiled", _castUI.transform.position, Quaternion.identity);
    ...
    private async UniTask InstantiateStoneAsync(Vector3 position)
    {
        ...
        */
        ...
        ParticleManager.Instance.PullParticleSync("ReverseGravityGlow", position, Quaternion.identity);
